    ...
    return (
        <div className="player-selected">
            ...
            <div className="select-player-body">
                ...
                <h4 className="select-player-name">Selected Player Name & Salary: <small>{names}</small></h4>
                <h4 className="total-salary">Total Budget: <FontAwesomeIcon icon={faDollarSign} />{totalSalary}</h4>
            </div>
        </div>
    );
};
